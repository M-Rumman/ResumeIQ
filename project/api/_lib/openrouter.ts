...
const DEFAULT_OPENROUTER_REQUEST_TIMEOUT_MS = 35_000;
const MIN_OPENROUTER_REQUEST_TIMEOUT_MS = 15_000;
...
export async function callOpenRouter(
  ...
  if (geminiKeys.length > 0 && models[0]?.startsWith('google/')) {
    ...
    if (geminiModel === 'gemini-flash-1.5' || geminiModel === 'gemini-1.5-flash') {
